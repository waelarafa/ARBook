...
public class ActivityMapManager : MonoBehaviour
{
    ...
    // ── AJOUT : Panel completion toutes activités ─────────────────
    [Header("Panel completion thème")]
    public GameObject themeCompletionPanel;
    // ─────────────────────────────────────────────────────────────
    ...
    IEnumerator RefreshAllAsync()
    {
        ...
        // ── AJOUT : affiche le panel si toutes les activités sont complétées ──
        if (allCompleted && themeCompletionPanel != null)
            themeCompletionPanel.SetActive(true);
        // ─────────────────────────────────────────────────────────────────────
    ...
    // ── AJOUT : Appelées depuis les boutons du panel dans l'Inspector ──
    public void CloseCompletionPanel()
    {
        if (themeCompletionPanel != null) themeCompletionPanel.SetActive(false);
    }
